"""Local HTTP API — called by the FleetGuard Plugin inside OpenClaw Gateway."""
...
def create_local_api(
    ...
    app = FastAPI(title="FleetGuard Sidecar Local API", version="0.1.0", docs_url=None, redoc_url=None)
