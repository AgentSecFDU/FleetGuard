#!/usr/bin/env python3
"""
FleetGuard Sidecar — Local device agent.

Usage:
  python -m fleetguard_sidecar.main
  python -m fleetguard_sidecar.main --enroll  # Force re-enrollment
  python -m fleetguard_sidecar.main --control-center http://192.168.1.100:8000
"""
...
from fleetguard_sidecar.enrollment import enroll, is_enrolled
from fleetguard_sidecar.heartbeat import HeartbeatLoop
from fleetguard_sidecar.policy_sync import PolicySyncer
from fleetguard_sidecar.event_queue import EventQueue
from fleetguard_sidecar.quarantine import QuarantineController
from fleetguard_sidecar.integrity import run_integrity_checks
from fleetguard_sidecar.local_api import create_local_api


async def main():
    parser = argparse.ArgumentParser(description="FleetGuard Sidecar")
    ...
    print("╔════════════════════════════════════════════╗")
    print("║   FleetGuard Sidecar v0.1.0                ║")
    print("╚════════════════════════════════════════════╝")
