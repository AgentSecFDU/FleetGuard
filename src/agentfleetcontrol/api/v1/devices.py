...
from agentfleetcontrol.schemas.auth import DeviceEnrollRequest, DeviceEnrollResponse
from agentfleetcontrol.schemas.device import (
    HeartbeatRequest, DeviceRead, DeviceListResponse,
    QuarantineRequest, DevicePolicyResponse,
)
from agentfleetcontrol.schemas.event import EventRead, EventListResponse
from agentfleetcontrol.services.device_service import (
    enroll_device, process_heartbeat, quarantine_device,
    unquarantine_device, get_device, list_devices,
)
from agentfleetcontrol.services.event_service import query_events
from agentfleetcontrol.api.v1.events import _event_to_read
...
async def get_device_policy_route(device_id: str, db: AsyncSession = Depends(get_db)):
    ...
    from agentfleetcontrol.services.policy_service import get_effective_policy_for_device as get_policy_yaml
