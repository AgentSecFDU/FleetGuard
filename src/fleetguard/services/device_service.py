...
from fleetguard.utils.crypto import hash_token, hash_password
from fleetguard.utils.id_generator import generate_device_api_token
...
async def enroll_device(
    ...
    from fleetguard.utils.crypto import verify_token
